...
//       className="w-full h-[600px] max-w-full mx-auto"
//     >
...
//             width={500}
//             height={600}
//             className="w-full h-[600px] rounded-lg shadow-lg transition duration-300 ease-in-out hover:invert"
//           />
//           {item.description && (
//             <p className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 text-white text-sm md:text-lg px-3 py-1 md:px-4 md:py-2 rounded-md">
//               {item.description}
//             </p>
//           )}
//         </a>
